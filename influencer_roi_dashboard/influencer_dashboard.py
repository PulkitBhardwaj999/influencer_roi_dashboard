...
# --- Merge DataFrames ---
merged = pd.merge(df_tracking, df_influencers, left_on="influencer_id", right_on="ID", how="left")
merged = pd.merge(merged, df_payouts, on="influencer_id", how="left")
...
# After merge, payout 'orders' becomes 'orders_y'; rename for clarity
...
payout_table = payout_table.rename(columns={"payout_orders": "orders"})  # For UI consistency
